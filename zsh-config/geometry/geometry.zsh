...
(($+GEOMETRY_PROMPT)) || GEOMETRY_PROMPT=(geometry_username geometry_path geometry_newline geometry_virtualenv geometry_status )
(($+GEOMETRY_RPROMPT)) || GEOMETRY_RPROMPT=(geometry_exec_time geometry_git geometry_npm_package_version geometry_node geometry_echo)
